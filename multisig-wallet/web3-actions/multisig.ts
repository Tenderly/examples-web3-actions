...
// TODO: replace
const TENDERLY_USERNAME = "TENDERLY_USERNAME";
const TENDERLY_PROJECT_SLUG = "multisig-wallet";

// TODO: replace with deployed contract addresses or use pre-deployed ones (leave as is)
const MULTISIG_WALLET_ADDRESS = "0x418ebb95eaa40c119408143056cad984c6129d45";
const MULTISIG_TOKEN_ADDRESS = "0x4e97c71a44ef1b78a7caee159aa016be53e04c32";
...
async function simulateOnFork(context: Context, submitted: SubmittedTx) {
  ...
  const tApi = tenderlyApi(
    TENDERLY_PROJECT_SLUG,
    TENDERLY_USERNAME,
    await context.secrets.get("TENDERLY_ACCESS_KEY")
  );
  const fork = await tApi.aTenderlyFork({ network_id: "3" });
